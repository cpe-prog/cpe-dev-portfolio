...
export default function Home() {
	return (
		<>
			...
			<main className="flex container justify-around items-center  pt-0 text-textDark w-full min-h-full">
				<div>
				...
				<div className="flex">
					...
					>
						<Image
							src={ProfileImage}
							alt="Profile.img"
							className="w-64 max-w-lg md:w-40 rounded-br-full rounded-tr-full"
						/>
					</motion.div>
				</div>
			</main>
