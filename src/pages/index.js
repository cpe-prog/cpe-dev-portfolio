			...
			<main className="flex items-center text-textDark w-full min-h-screen">
				<Layout className="pt-0">
					<div className="flex items-center justify-center gap-32 w-full">
						<div>
							<div></div>
							<h2 className="text-md cursor-default p-2 w-44 rounded-md mb-5 text-bgLight bg-gradient-to-l from-textDark to-activeBorderBottom via-50% gradiantBackground">
								👋 Hi! I'm Grian Gajila
							</h2>
							<div>
