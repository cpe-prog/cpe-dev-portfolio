...
export default function Home() {
	return (
		<>
			...
			<main className="flex relative items-center text-textDark w-full min-h-screen">
				<Draggable>
					<div className="flex absolute rounded-lg h-20 w-20  bg-gradient-to-tl from-textDark via-bgLight to-textDark via-50% shadow-2xl background-animate"></div>
				</Draggable>
