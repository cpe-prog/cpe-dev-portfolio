...
export default function Home() {
	return (
		<>
			...
			<main className=" items-center grid grid-cols-1 md:grid-cols-2  pt-0 text-textDark w-full h-screen">
					...
					<div className="flex">
						...
						>
							<Image
								src={ProfileImage}
								alt="Profile.img"
								className="w-64 max-w-lg md:w-40 lg:w-64 rounded-br-full rounded-tr-full"
							/>
						</motion.div>
					</div>
				</div>
